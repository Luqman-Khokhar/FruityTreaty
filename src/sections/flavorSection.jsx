...
const FlavorSection = () => {
  return (
  <div className='m-10 '>
  <h1 className='justify-center items-center text-5xl text-[#724c34] font-bold mb-20 font-mono '>FLAVORS</h1>
{/* BANANA STARTS */}
  <div className='flex flex-1 flex-row bg-yellow-200'>
...
<img src='../images/banana.jpeg' alt='banana' className='w-[80%] h-auto'/>
  ...
  <h1 className='font-bold text-7xl font-mono'>BANANA FLAVOR</h1>
...
{/* PAYA STARTS */}
<div className='flex flex-1 flex-row bg-[#f58b6a] my-10 pl-5 '>

<div className='flex flex-1 flex-col   items-start space-y-10 lg:pt-[100px]'>
<h1 className='font-bold text-7xl font-mono'>PAYA FLAVOR</h1>
...
<div className='flex flex-1 flex-row space-x-5'>
<h1 className='text-[#f0704a] font-bold text-xl'>700$</h1>
<h1>Price</h1>
<h1 className='text-[#f0704a] font-bold text-xl'>7000</h1>
<h1>Stock</h1>
</div>
<div> 
...
{/* COCONUT STARTS */}
<div className='flex flex-1 flex-row bg-[#ea957d]'>
...
<div className='flex flex-1 flex-col   items-start space-y-10 lg:pt-[130px]'>
<h1 className='font-bold text-7xl font-mono'>COCONUT FLAVOR</h1>
<p className='text-left pr-10'>
